...
The goal of `tfhunter` is to identify transcription factors from protein sequence data and classify them into families and subfamilies.
...
```{r example, eval = requireNamespace('tfhunter')}
library("tfhunter")
## basic example code
```
