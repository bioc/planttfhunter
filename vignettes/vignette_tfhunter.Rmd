...
list of 4 `AAStringSet` objects by sampling 100 random genes from the example
data set `gsu` 4 times. We will also create a toy species metadata data frame
...
Great, now we have a list of 4 `AAStringSet` objects. Let's also create a 
