...
gene regulatory networks. `tfhunter` allows users to identify plant TFs 
from whole-genome protein sequences and classify them into families 
and subfamilies (when applicable) using the classification scheme
implemented in [PlantTFDB](http://planttfdb.gao-lab.org/).
...
# Classify TFs into families and subfamilies
if(hmmer_is_installed()) {
